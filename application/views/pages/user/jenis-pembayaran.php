<div class="row d-flex flex-wrap justify-content-center align-self-center pt-2">
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-header">
                        <h2 class="modal-title" id="modalAsuransiLabel">PILIH JENIS ASURANSI</h2>
                        <a class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i data-feather="x"></i></a>
                    </div>
                    <div class="modal-body">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-12 d-flex px-2">
                                <input type="text" class="rounded-pill form-control" placeholder="CARI ASURANSI">
                            </div>
                        </div>
                        <div class="row">
